...
class ClinicTimings extends React.Component{
  constructor(props) {
    ...
    this.state = {
      ...
      allTimefrom:"",
      allTimeto:"",
      monTimefrom: props.timings[0].open_time,
      tuesTimefrom: props.timings[1].open_time,
      wednesTimefrom: props.timings[2].open_time,
      thursTimefrom: props.timings[3].open_time,
      friTimefrom: props.timings[4].open_time,
      saturTimefrom: props.timings[5].open_time,
      sunTimefrom: props.timings[6].open_time,
      allTimeto:"",
      monTimeto:props.timings[0].close_time,
      tuesTimeto:props.timings[1].close_time,
      wednesTimeto:props.timings[2].close_time,
      thursTimeto:props.timings[3].close_time,
      friTimeto:props.timings[4].close_time,
      saturTimeto:props.timings[5].close_time,
      sunTimeto:props.timings[6].close_time,
      bttnclicked:"custom",
    ...
    this.handleInitialCheckbox = this.handleInitialCheckbox.bind(this);
  }
  ...
  setTimingsFormat(callback){
    ...
    if(moment.utc(this.state.monTimefrom).format("hh:mm A") != "Invalid date"){
      ...
      monopentime = this.state.monTimefrom;
    }
    if(moment.utc(this.state.tuesTimefrom).format("hh:mm A") != "Invalid date"){
      ...
      tuesopentime = this.state.tuesTimefrom;
    }
    if(moment.utc(this.state.wednesTimefrom).format("hh:mm A") != "Invalid date"){
      ...
      wednesopentime = this.state.wednesTimefrom;
    }
    if(moment.utc(this.state.thursTimefrom).format("hh:mm A") != "Invalid date"){
      ...
      thursopentime = this.state.thursTimefrom;
    }
    if(moment.utc(this.state.friTimefrom).format("hh:mm A") != "Invalid date"){
      ...
      friopentime = this.state.friTimefrom;
    }
    if(moment.utc(this.state.saturTimefrom).format("hh:mm A") != "Invalid date"){
      ...
      saturopentime = this.state.saturTimefrom;
    }
    if(moment.utc(this.state.sunTimefrom).format("hh:mm A") != "Invalid date"){
      ...
      sunopentime = this.state.sunTimefrom;
    }
    if(moment.utc(this.state.monTimeto).format("hh:mm A") != "Invalid date"){
      ...
      monclosetime = this.state.monTimeto;
    }
    if(moment.utc(this.state.tuesTimeto).format("hh:mm A") != "Invalid date"){
      ...
      tuesclosetime = this.state.tuesTimeto;
    }
    if(moment.utc(this.state.wednesTimeto).format("hh:mm A") != "Invalid date"){
      ...
      wednesclosetime = this.state.wednesTimeto;
    }
    if(moment.utc(this.state.thursTimeto).format("hh:mm A") != "Invalid date"){
      ...
      thursclosetime = this.state.thursTimeto;
    }
    if(moment.utc(this.state.friTimeto).format("hh:mm A") != "Invalid date"){
      ...
      friclosetime = this.state.friTimeto;
    }
    if(moment.utc(this.state.saturTimeto).format("hh:mm A") != "Invalid date"){
      ...
      saturclosetime = this.state.saturTimeto;
    }
    if(moment.utc(this.state.sunTimeto).format("hh:mm A") != "Invalid date"){
      ...
      sunclosetime = this.state.sunTimeto;
    }
  ...
  handleInitialCheckbox(){
    const newChecked = [];
    var i;
    for(i in this.props.timings){
      if(this.props.timings[i].open_time !== "")
      {
        var day = this.props.timings[i].day;
        var value = this.state.indexName.indexOf(day) + 1;
